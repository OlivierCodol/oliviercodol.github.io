      ...
      window.location.href = "/";
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "materials-optimal-control-systems",
          title: 'Optimal Control Systems',
          description: "",
          section: "Materials",handler: () => {
              window.location.href = "/materials/1_material/";
            },},{id: "materials-optimal-control-and-estimation",
          title: 'Optimal Control and Estimation',
          description: "",
          section: "Materials",handler: () => {
              window.location.href = "/materials/2_material/";
            },},{id: "materials-lagrange-multipliers",
          title: 'Lagrange Multipliers',
          description: "",
          section: "Materials",handler: () => {
              window.location.href = "/materials/3_material/";
            },},{id: "materials-neuromechanics-of-human-motion",
          title: 'Neuromechanics of Human Motion',
          description: "",
          section: "Materials",handler: () => {
              window.location.href = "/materials/4_material/";
            },},{id: "materials-imaginary-numbers",
          title: 'Imaginary Numbers',
          description: "",
          section: "Materials",handler: () => {
              window.location.href = "/materials/5_material/";
            },},{id: "materials-support-vector-machines",
          title: 'Support Vector Machines',
          description: "",
          section: "Materials",handler: () => {
              window.location.href = "/materials/6_material/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://bsky.app/profile/oliviercodol.bsky.social", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        section: 'Socials',
        handler: () => {
          window.open("mailto:%63%6F%64%6F%6C.%6F%6C%69%76%69%65%72@%67%6D%61%69%6C.%63%6F%6D", "_blank");
        },
      },{
        id: 'social-github',
        title: 'GitHub',
        section: 'Socials',
        handler: () => {
          window.open("https://github.com/OlivierCodol", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/olivier-codol-0360ab91", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0000-0003-0796-5457", "_blank");
        },
      },{
        id: 'social-osf',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://osf.io/dyp5x/", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=cOqh6rEAAAAJ", "_blank");
        },
      },{
        id: 'social-rss',
        title: 'RSS Feed',
